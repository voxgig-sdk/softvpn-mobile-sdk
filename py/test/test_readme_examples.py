# SoftvpnMobile SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SoftvpnMobileSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SoftvpnMobileSDK(...) and SoftvpnMobileSDK.test(...) become
#      SoftvpnMobileSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "softvpnmobile_sdk"
_SDK_CLASS = "SoftvpnMobileSDK"
