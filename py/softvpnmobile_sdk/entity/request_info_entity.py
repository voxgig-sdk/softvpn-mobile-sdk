...
from softvpnmobile_sdk.softvpnmobile_types import (
    RequestInfo,
    RequestInfoLoadMatch,
)
...
class RequestInfoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RequestInfoEntity(self._client, opts)
    ...
    def match_get(self) -> RequestInfo:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RequestInfo:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RequestInfo().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
