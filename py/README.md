# SoftvpnMobile Python SDK



The Python SDK for the SoftvpnMobile API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.RequestInfo()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/softvpn-mobile-sdk/releases)) or
...
client = SoftvpnMobileSDK(options)
```
...
| --- | --- | --- |
| `city` | `str` | City |
| `country` | `str` | Country of the IP address |
...
```
py/
├── softvpnmobile_sdk.py         -- Main SDK module
