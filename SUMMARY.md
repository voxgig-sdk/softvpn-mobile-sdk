...
Results: Successful response with IP request information.
...
Results: Successful response with list of VPN servers.
...
| --- | --- | --- | --- |
| RequestInfo | `load` | `GET /request-ip` | See reference |
| Server | `list` | `GET /servers` | See reference |

## Connect to the API

- SoftVPN API Server: `http://74.119.194.157/api/v1`
...
- `softvpn-mobile_list`: List records for an entity. Supported entities: `server`.
- `softvpn-mobile_load`: Load one record for an entity. Supported entities: `request_info`.
