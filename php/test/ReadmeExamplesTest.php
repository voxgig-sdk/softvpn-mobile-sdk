...
// SoftvpnMobile SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SoftvpnMobileSDK::test)
...
{
    private const SDK_CLASS = 'SoftvpnMobileSDK';
    ...
    private const SDK_BASE = 'softvpnmobile_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../softvpnmobile_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
