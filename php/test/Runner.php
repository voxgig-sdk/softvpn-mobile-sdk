...
class SoftvpnMobileTestRunner
{
    ...
    {
        $live = self::getenv('SOFTVPN_MOBILE_TEST_LIVE');
        $override = self::getenv('SOFTVPN_MOBILE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SOFTVPN_MOBILE_TEST_EXPLAIN');
...
class_alias('SoftvpnMobileTestRunner', 'Runner');
class_alias('SoftvpnMobileHelpers', 'Helpers');
