...
// SoftvpnMobile SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SoftvpnMobileOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SoftvpnMobileOmni::structfix($now, Struct::undef()))
                        !== json_encode(SoftvpnMobileOmni::structfix($val, Struct::undef()))) {
