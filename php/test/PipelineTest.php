...
// SoftvpnMobile SDK pipeline test
//
...
require_once __DIR__ . '/../softvpnmobile_sdk.php';
...
{
    private static function utility(): SoftvpnMobileUtility
    {
        return new SoftvpnMobileUtility();
    }
    ...
    private static function ctx(array $over = []): SoftvpnMobileContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SoftvpnMobileContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SoftvpnMobileOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SoftvpnMobileError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SoftvpnMobileOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SoftvpnMobileMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SoftvpnMobileOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SoftvpnMobileMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SoftvpnMobileOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SoftvpnMobileMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SoftvpnMobileSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SoftvpnMobileMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SoftvpnMobileResponse([]),
            'result' => new SoftvpnMobileResult([]),
        ]);
        [, $err] = SoftvpnMobileMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SoftvpnMobileSpec([]),
            'response' => null,
            'result' => new SoftvpnMobileResult([]),
        ]);
        [, $err] = SoftvpnMobileMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SoftvpnMobileSpec(['step' => 's']),
            'response' => new SoftvpnMobileResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SoftvpnMobileResult([]),
        ]);
        [, $err] = SoftvpnMobileMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SoftvpnMobileSpec(['step' => 's']),
            'response' => new SoftvpnMobileResponse(self::resp(200, ['v' => 1])),
            'result' => new SoftvpnMobileResult([]),
        ]);
        [, $err] = SoftvpnMobileMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SoftvpnMobileSpec(['step' => 's']),
            'response' => new SoftvpnMobileResponse(self::resp(200, ['v' => 2])),
            'result' => new SoftvpnMobileResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SoftvpnMobileMakeResponse::call($ctx);
    ...
    {
        $preset = new SoftvpnMobileResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SoftvpnMobileSpec([]),
            'response' => new SoftvpnMobileResponse([]),
            'result' => new SoftvpnMobileResult([]),
        ...
        [$got, $err] = SoftvpnMobileMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SoftvpnMobileResult([])]);
        [, $err] = SoftvpnMobileMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SoftvpnMobileSpec([]), 'result' => null]);
        [, $err] = SoftvpnMobileMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SoftvpnMobileSpec(['step' => 's']),
            'result' => new SoftvpnMobileResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SoftvpnMobileOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SoftvpnMobileMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SoftvpnMobileSpec(['step' => 's']),
            'result' => new SoftvpnMobileResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SoftvpnMobileOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SoftvpnMobileMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SoftvpnMobileResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SoftvpnMobileSpec([]),
            'result' => new SoftvpnMobileResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SoftvpnMobileMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SoftvpnMobileMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SoftvpnMobileError('boom', 'boom');
        $utility->fetcher = function (SoftvpnMobileContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SoftvpnMobileSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SoftvpnMobileMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SoftvpnMobileContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SoftvpnMobileMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SoftvpnMobileResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SoftvpnMobileMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SoftvpnMobileContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SoftvpnMobileSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SoftvpnMobileMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SoftvpnMobileResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SoftvpnMobileSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SoftvpnMobileMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SoftvpnMobileMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SoftvpnMobileMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SoftvpnMobileResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SoftvpnMobileDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SoftvpnMobileResult(['ok' => false])]);
        $this->expectException(SoftvpnMobileError::class);
        SoftvpnMobileDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SoftvpnMobileResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SoftvpnMobileMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SoftvpnMobileMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SoftvpnMobileBaseFeature();
        $b = new SoftvpnMobileBaseFeature();
        SoftvpnMobileFeatureAdd::call($ctx, $a);
        SoftvpnMobileFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SoftvpnMobileBaseFeature
    {
        $f = new SoftvpnMobileBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SoftvpnMobileFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SoftvpnMobileContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SoftvpnMobileSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SoftvpnMobilePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SoftvpnMobilePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SoftvpnMobileResponse(['headers' => null]),
            'result' => new SoftvpnMobileResult([]),
        ]);
        SoftvpnMobileResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        SoftvpnMobileResultBody::call($ctx);
