...
// SoftvpnMobile SDK proxy feature
...
class SoftvpnMobileProxyFeature extends SoftvpnMobileBaseFeature
{
    ...
    public function init(SoftvpnMobileContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SoftvpnMobileContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
