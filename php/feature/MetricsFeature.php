...
// SoftvpnMobile SDK metrics feature
...
class SoftvpnMobileMetricsFeature extends SoftvpnMobileBaseFeature
{
    ...
    private function _record(SoftvpnMobileContext $ctx, bool $ok): void
    {
