...
// SoftvpnMobile SDK ratelimit feature
...
class SoftvpnMobileRatelimitFeature extends SoftvpnMobileBaseFeature
{
    ...
    private function _acquire(SoftvpnMobileContext $ctx): void
    {
    ...
    private function _track(SoftvpnMobileContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
