...
// SoftvpnMobile SDK audit feature
...
class SoftvpnMobileAuditFeature extends SoftvpnMobileBaseFeature
{
    ...
    private function _emit(SoftvpnMobileContext $ctx, string $outcome): void
    {
