...
// SoftvpnMobile SDK clienttrack feature
...
class SoftvpnMobileClienttrackFeature extends SoftvpnMobileBaseFeature
{
    ...
    public function PostConstruct(SoftvpnMobileContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SoftvpnMobile-SDK';
