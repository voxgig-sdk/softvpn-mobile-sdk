...
// SoftvpnMobile SDK netsim feature
...
class SoftvpnMobileNetsimFeature extends SoftvpnMobileBaseFeature
{
    ...
    private function _simulate(SoftvpnMobileContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SoftvpnMobileContext $ctx, array $applied): void
    {
        $client = $this->client;
