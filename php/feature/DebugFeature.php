...
// SoftvpnMobile SDK debug feature
...
class SoftvpnMobileDebugFeature extends SoftvpnMobileBaseFeature
{
    ...
    private function _finish(SoftvpnMobileContext $ctx, bool $ok): void
    {
