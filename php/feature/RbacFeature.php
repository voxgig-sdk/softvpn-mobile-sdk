...
// SoftvpnMobile SDK rbac feature
...
class SoftvpnMobileRbacFeature extends SoftvpnMobileBaseFeature
{
    ...
    private function _required(SoftvpnMobileContext $ctx): ?string
    {
    ...
    private function _reject(SoftvpnMobileContext $ctx, string $required): void
    {
    ...
    private function _track(SoftvpnMobileContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
