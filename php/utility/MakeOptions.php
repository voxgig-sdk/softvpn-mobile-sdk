...
// SoftvpnMobile SDK utility: make_options

class SoftvpnMobileMakeOptions
{
    ...
    public static function call(SoftvpnMobileContext $ctx): array
    {
        ...
        //
        // `SoftvpnMobileSchema::optspec()` is built from the model:
        ...
        $optspec = SoftvpnMobileSchema::optspec();
