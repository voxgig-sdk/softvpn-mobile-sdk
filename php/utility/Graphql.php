...
// SoftvpnMobile SDK utility: graphql
//
...
class SoftvpnMobileGraphql
{
    ...
    // equivalent.
    public static function body(SoftvpnMobileContext $ctx): mixed
    {
    ...
    public static function errors(SoftvpnMobileContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
