...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.SOFTVPNMOBILE_TEST_LIVE ||
    'TRUE' === process.env.SOFTVPNMOBILE_TEST_OVERRIDE
  ) {
  ...
  m.SOFTVPNMOBILE_TEST_EXPLAIN = process.env.SOFTVPNMOBILE_TEST_EXPLAIN || m.SOFTVPNMOBILE_TEST_EXPLAIN
