...
function envOverride(m) {
    if ('TRUE' === process.env.SOFTVPN_MOBILE_TEST_LIVE ||
        'TRUE' === process.env.SOFTVPN_MOBILE_TEST_OVERRIDE) {
    ...
    m.SOFTVPN_MOBILE_TEST_EXPLAIN = process.env.SOFTVPN_MOBILE_TEST_EXPLAIN || m.SOFTVPN_MOBILE_TEST_EXPLAIN;
    return m;
}
