...
(0, node_test_1.describe)('RequestInfoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SoftvpnMobileSDK({
    ...
    (0, node_test_1.test)('direct-load-request_info', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-request_info', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SOFTVPN_MOBILE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SoftvpnMobileSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SOFTVPN_MOBILE_TEST_REQUEST_INFO_ENTID'];
    ...
    const client = new __1.SoftvpnMobileSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RequestInfoDirect.test.js.map