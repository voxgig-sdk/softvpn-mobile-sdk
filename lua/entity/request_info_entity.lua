...
local RequestInfoEntity = {}
RequestInfoEntity.__index = RequestInfoEntity


function RequestInfoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RequestInfoEntity)
  self._name = "request_info"
  self._client = client
...
function RequestInfoEntity:get_name()
  return self._name
end


function RequestInfoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RequestInfoEntity.new(self._client, opts)
end
...
function RequestInfoEntity:mark_deleted()
  self._deleted = true
end


function RequestInfoEntity:deleted()
  return true == self._deleted
end


function RequestInfoEntity:data_set(args)
  if args ~= nil then
...
function RequestInfoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RequestInfoEntity:match_set(args)
  if args ~= nil then
...
function RequestInfoEntity:match_get()
...
function RequestInfoEntity:stream(action, args, callopts)
...
---@param reqmatch RequestInfoLoadMatch
---@param ctrl? table
---@return RequestInfo
---@return string? err
function RequestInfoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RequestInfoEntity:_run_op(ctx, post_done)
  local utility = self._utility
