...
describe("RequestInfoEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SOFTVPNMOBILE_TEST_REQUEST_INFO_ENTID JSON to run live")
      return
    end
...
function request_info_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SOFTVPNMOBILE_TEST_REQUEST_INFO_ENTID")
  ...
  if env["SOFTVPNMOBILE_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["SOFTVPNMOBILE_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
