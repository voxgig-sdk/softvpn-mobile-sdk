...
describe("RequestInfoDirect", function()
  it("should direct-load-request_info", function()
    local setup = request_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-request_info", setup.live and "live" or "unit")
