...
describe("ServerEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SOFTVPN_MOBILE_TEST_SERVER_ENTID JSON to run live")
      return
    end
...
function server_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SOFTVPN_MOBILE_TEST_SERVER_ENTID")
