...
function runner.env_override(m)
  local live = runner.getenv("SOFTVPN_MOBILE_TEST_LIVE")
  local override = runner.getenv("SOFTVPN_MOBILE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SOFTVPN_MOBILE_TEST_EXPLAIN")
