...
function runner.env_override(m)
  local live = runner.getenv("SOFTVPNMOBILE_TEST_LIVE")
  local override = runner.getenv("SOFTVPNMOBILE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SOFTVPNMOBILE_TEST_EXPLAIN")
