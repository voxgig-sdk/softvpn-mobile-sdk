...
import (
	...
	vs "github.com/voxgig-sdk/softvpn-mobile-sdk/go/utility/struct"
)

type RequestInfoEntity struct {
	name    string
	client  *core.SoftvpnMobileSDK
...
func NewRequestInfoEntity(client *core.SoftvpnMobileSDK, entopts map[string]any) *RequestInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RequestInfoEntity) GetName() string { return e.name }
...
func (e *RequestInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RequestInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *RequestInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRequestInfoEntity(e.client, opts)
}

func (e *RequestInfoEntity) Data(args ...any) any {
...
func (e *RequestInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RequestInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RequestInfoEntity) DataTyped(data ...RequestInfo) RequestInfo {
	if len(data) > 0 {
		return typedFrom[RequestInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[RequestInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RequestInfo (all fields
// optional at the wire level).
func (e *RequestInfoEntity) MatchTyped(match ...RequestInfo) RequestInfo {
	if len(match) > 0 {
		return typedFrom[RequestInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[RequestInfo](e.Match())
}
...
func (e *RequestInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RequestInfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RequestInfoLoadMatch and returns an RequestInfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RequestInfoEntity) LoadTyped(reqmatch RequestInfoLoadMatch, ctrl map[string]any) (RequestInfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RequestInfo{}, err
	}
	return typedFrom[RequestInfo](res), nil
}



func (e *RequestInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RequestInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RequestInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RequestInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RequestInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
