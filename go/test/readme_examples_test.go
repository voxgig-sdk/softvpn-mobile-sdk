...
const testSeed = `map[string]any{"entity": map[string]any{"request_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "server": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
