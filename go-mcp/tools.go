...
type Args struct {
	Entity string         `json:"entity" jsonschema:"request_info | server"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SoftvpnMobileSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "softvpn-mobile_list",
		Description: "List records from SoftvpnMobile. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "softvpn-mobile_load",
		Description: "Load a single record from SoftvpnMobile. " +
...
func runOp(client *sdk.SoftvpnMobileSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SoftvpnMobileSDK, name string) (sdk.SoftvpnMobileEntity, error) {
	switch strings.ToLower(name) {
	case "request_info":
		return client.RequestInfo(nil), nil
	case "server":
