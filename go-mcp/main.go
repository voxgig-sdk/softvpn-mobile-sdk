// Command SoftvpnMobile-mcp is an MCP server exposing the SoftvpnMobile
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SoftvpnMobile_list  — list records of an entity
//	SoftvpnMobile_load  — load a single record of an entity
//
