...
func registerSDKWords(r *eng.Registry, client *sdk.SoftvpnMobileSDK) {
...
func runOp(client *sdk.SoftvpnMobileSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
