...
|---|---|---|
| `ts/` | @voxgig-sdk/softvpn-mobile-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/softvpn-mobile-sdk \
      --repository voxgig-sdk/softvpn-mobile-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/softvpn-mobile-sdk` shows it, and
`npm trust revoke @voxgig-sdk/softvpn-mobile-sdk --id=<id>` removes it.
