...
// SoftvpnMobile SDK utility: fetcher

class SoftvpnMobileFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SoftvpnMobileSDK/1.0)';
    ...
    public static function call(SoftvpnMobileContext $ctx, string $fullurl, array $fetchdef): array
    {
