...
// SoftvpnMobile SDK utility type

class SoftvpnMobileUtility
{
    ...
    public static function copy(SoftvpnMobileUtility $src): SoftvpnMobileUtility
    {
        $u = new SoftvpnMobileUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
