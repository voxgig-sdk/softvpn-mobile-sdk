...
// SoftvpnMobile SDK cache feature
...
class SoftvpnMobileCacheFeature extends SoftvpnMobileBaseFeature
{
    ...
    private function _through(SoftvpnMobileContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
