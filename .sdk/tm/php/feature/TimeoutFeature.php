...
// SoftvpnMobile SDK timeout feature
...
class SoftvpnMobileTimeoutFeature extends SoftvpnMobileBaseFeature
{
    ...
    private function _with_timeout(SoftvpnMobileContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SoftvpnMobileContext $_ctx, float $ms): void
    {
        $client = $this->client;
