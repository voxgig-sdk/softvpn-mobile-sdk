...
from projectname_sdk.core.control import SoftvpnMobileControl
...
class SoftvpnMobileContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SoftvpnMobileControl()
        ...
        if isinstance(sp, SoftvpnMobileSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SoftvpnMobileResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SoftvpnMobileResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SoftvpnMobileError(code, msg, self)
